...
import EventTitleStept from "../eventtitlestep/EventTitleStep2";
  ...
  const getStepContent = (step) => {
    switch (step) {
      case 0:
        ...
        return <EventTitleStept handleInputChange={handleInputChange} title={eventData.title} />
      case 1:
  ...
  return (
    <div className="container">
      <div className="mt-5 p-5">
        <Box sx={{ width: '100%', maxWidth: '900px', margin: 'auto', padding: '20px', border: '1px solid #ccc', borderRadius: '10px'}}>
          <div className="container">
            <Box sx={{ width: '100%' }}>
              <Stepper className="pb-2" activeStep={activeStep}>
              ...
              <div>
                {submissionComplete ? (
                  ...
                  <React.Fragment>
                    <Typography className="" sx={{ mt: 2, mb: 3 }}>{getStepContent(activeStep)}</Typography>
